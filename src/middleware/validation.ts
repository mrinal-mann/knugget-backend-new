...
export const generateSummarySchema = z.object({
  body: z.object({
    transcript: z.array(transcriptSegmentSchema).min(1, 'Transcript segments are required'),
...
export const saveSummarySchema = z.object({
  body: z.object({
    ...
    fullSummary: z.string().min(1, 'Full summary is required').max(5000, 'Summary too long'),
...
export const updateSummarySchema = z.object({
  body: z.object({
    ...
    fullSummary: z.string().min(1, 'Summary cannot be empty').max(5000, 'Summary too long').optional(),
...
export const summaryQuerySchema = z.object({
  query: z.object({
    ...
    sortBy: z.enum(['createdAt', 'title', 'videoTitle']).default('createdAt').optional(),
